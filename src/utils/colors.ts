...
const blue = {
    CadetBlue, SteelBlue, LightBlue, LightSteelBlue,
    PowderBlue, LightSkyBlue, SkyBlue, CornflowerBlue, DeepSkyBlue,
    DodgerBlue, RoyalBlue, Blue, MediumBlue, DarkBlue, Navy, MidnightBlue
};
...
const green = {
    ...
    SpringGreen, MediumSeaGreen, SeaGreen, ForestGreen, Green,
...
const brown = {
    ...
    Olive, SaddleBrown, Sienna, Brown, Maroon
};
...
const color = {
    purple, blue, red, yellow, green, cyan, brown, white, gray
};
